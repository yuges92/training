  <ul class="">
    ...
    <li><a class="{{ Request::is('learner/order*') ? 'active' : '' }}" href=""><i class="fas fa-graduation-cap"></i> <span>My Courses</span></a></li>
    ...
    <li><a class="{{ Request::is('learner/myNotification*') ? 'active' : '' }}" href=""><i class="fas fa-bell"></i> <span>Notifications</span></a></li>
