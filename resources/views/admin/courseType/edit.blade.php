...
@endpush 
@section('title', 'Edit - '.$courseType->title) 
@section('content')
<div class="container-fluid p-sm-0 px-md-5 ">
  <form class="" action="{{route('courseTypes.update', $courseType->id)}}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    @method('PUT')
        ...
        <div class="box">
          <div class="box-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input name="title" type="text" class="form-control" id="title" value="{{ $courseType->title }}" placeholder="Title">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea id="description" class="form-control" name="description" rows="4" cols="80" maxlength="300">{{ $courseType->description }}</textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea id="ckEditor" class="form-control summernote" name="body" rows="8" cols="80">{!! $courseType->body !!}</textarea>
              </div>
            </div>
        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="form-group ">
              ...
              <div class="col">
                <select class="form-control" name="status" id="status">
                  <option {{ ($courseType->status=='publish') ? 'selected' : '' }} value="publish">Publish</option>
                  <option {{ ($courseType->status=='draft') ? 'selected' : '' }} value="draft">Draft</option>
                  <option {{ ($courseType->status=='private') ? 'selected' : '' }} value="private">private</option>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col">
                  <div class="">
                    <input type="file" name="image" class="dropify" data-min-height="200" data-min-width="300" data-default-file="{{ $courseType->getImage() }}" data-allowed-file-extensions="png JPEG jpg" data-max-file-size="1MB">
                  </div>
                </div>
              </div>
          </div>
